...
import { DesciplineEnforcementService } from 'src/app/_service';

@Component({
  selector: 'app-descipline-and-enforcement',
  templateUrl: './descipline-and-enforcement.component.html',
  styleUrls: ['./descipline-and-enforcement.component.css'],
})
export class DesciplineAndEnforcementComponent {
  constructor(
    private route: ActivatedRoute,
    private router: Router,
    private service: DesciplineEnforcementService
  ) {}
