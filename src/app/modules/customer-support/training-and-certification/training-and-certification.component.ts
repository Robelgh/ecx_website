...
import { TrainingCertificationService } from 'src/app/_service';

@Component({
  selector: 'app-training-and-certification',
  templateUrl: './training-and-certification.component.html',
  styleUrls: ['./training-and-certification.component.css'],
})
export class TrainingAndCertificationComponent {
  constructor(
    private route: ActivatedRoute,
    private router: Router,
    private service: TrainingCertificationService
  ) {}
