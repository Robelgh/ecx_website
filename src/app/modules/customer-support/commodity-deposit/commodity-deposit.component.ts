...
import { CommodityDepositService } from 'src/app/_service';

@Component({
  selector: 'app-commodity-deposit',
  templateUrl: './commodity-deposit.component.html',
  styleUrls: ['./commodity-deposit.component.css'],
})
export class CommodityDepositComponent {
  constructor(
    private route: ActivatedRoute,
    private router: Router,
    private service: CommodityDepositService
  ) {}
