...
import { WHRFinancingService } from 'src/app/_service';

@Component({
  selector: 'app-whr-financing',
  templateUrl: './whr-financing.component.html',
  styleUrls: ['./whr-financing.component.css'],
})
export class WhrFinancingComponent {
  constructor(
    private route: ActivatedRoute,
    private router: Router,
    private service: WHRFinancingService
  ) {}
