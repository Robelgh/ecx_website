...
import { TradeEthicsService } from 'src/app/_service';

@Component({
  selector: 'app-trade-ethics',
  templateUrl: './trade-ethics.component.html',
  styleUrls: ['./trade-ethics.component.css'],
})
export class TradeEthicsComponent {
  constructor(
    private route: ActivatedRoute,
    private router: Router,
    private service: TradeEthicsService
  ) {}
