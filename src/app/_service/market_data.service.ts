...
export class MarketDatatService {
  ...
  async GetScrollingData() {
    ...
    return await firstValueFrom(this.http.get(`${baseUrl}/${'scrollingdata'}`));
  }
  ...
  async GetCommodityMarketData(commodity : string) {
    return await firstValueFrom(this.http.get(`${baseUrl}/${commodity}`));
  }

  async GetSymbolMarketData(symbol : string) {
    return await firstValueFrom(this.http.get(`${baseUrl}/symbol/${symbol}`));
  }
